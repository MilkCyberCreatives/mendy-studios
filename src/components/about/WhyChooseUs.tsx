  ...
  return (
    <section data-reveal className="bg-black text-white py-24 px-6">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <p className="text-gray-300 mb-12">Here&apos;s what sets us apart from the rest.</p>

        <div className="grid md:grid-cols-3 sm:grid-cols-2 gap-8">
          {features.map((feature, index) => (
            <motion.div
              key={index}
              className="bg-white/5 p-6 rounded-lg border border-white/10 transition duration-300"
