...
const services = [
  {
    ...
    description:
      'Weddings, events, portraits, and studio photography sessions tailored for every moment.',
  },
  {
    title: 'Videography',
    icon: <FaVideo size={28} />,
    description:
      'Professional video coverage for weddings, music videos, events, and business content.',
  },
  {
    title: 'Streaming Services',
    icon: <FaBroadcastTower size={28} />,
    description:
      'Multi-camera livestreams for funerals, church events, and social platforms with overlays.',
  },
  {
    title: 'Video Editing',
    icon: <FaMagic size={28} />,
    description:
      'Cinematic editing, audio enhancement, highlight reels, and branded content creation.',
  },
  {
    title: 'Studio Sessions',
    icon: <FaHome size={28} />,
    description:
      'Indoor photo shoots with props and lighting - ideal for branding or lifestyle shots.',
  },
  {
    title: 'Photo Albums & Prints',
    icon: <FaImages size={28} />,
    description:
      'Beautifully crafted photo albums, canvases, and print packages to preserve your memories.',
  },
];
